...
this server's own directories, or is where a link directly inside a credential
directory points; those and the raw model paths are refused whether or not the
file is there. All under any spelling
